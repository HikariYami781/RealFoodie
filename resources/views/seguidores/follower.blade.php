                ...
                <div class="card-body text-center py-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="{{ route('users.following', $user) }}" class="btn btn-outline-primary">
                            ...
                            Siguiendo ({{ $user->siguiendo->count() }})
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card user-card h-100">
                        <div class="card-body text-center">
                            ...
                            @if($seguidor->foto_perfil)
                                <img src="{{ asset('storage/fotos_perfil/' . $seguidor->foto_perfil) }}" 
                                    class="rounded-circle profile-img mb-3" 
                            ...
                            <div class="d-flex justify-content-center gap-3 mb-3">
                                <span class="stats-badge">
                                    ...
                                    {{ $seguidor->recetas->count() }} recetas
                                </span>
                                <span class="stats-badge">
                                    <i class="fas fa-users me-1"></i>
                                    {{ $seguidor->seguidores->count() }} seguidores
                                </span>
                            </div>
